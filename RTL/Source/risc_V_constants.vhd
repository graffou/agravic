...
constant OP_MULDIV : unsigned ((7 -1) downto 0) := "0110010";
...
constant CASE_OP_MULDIV : unsigned ((7 -1) downto 0) := "0110010";
...
constant MUL : unsigned ((3 -1) downto 0) := "000";
constant MULH : unsigned ((3 -1) downto 0) := "001";
constant MULHSU : unsigned ((3 -1) downto 0) := "010";
constant MULHU : unsigned ((3 -1) downto 0) := "011";
constant DIV : unsigned ((3 -1) downto 0) := "100";
constant DIVU : unsigned ((3 -1) downto 0) := "101";
constant REMS : unsigned ((3 -1) downto 0) := "110";
constant REMU : unsigned ((3 -1) downto 0) := "111";


constant CASE_MUL : unsigned ((3 -1) downto 0) := "000";
constant CASE_MULH : unsigned ((3 -1) downto 0) := "001";
constant CASE_MULHSU : unsigned ((3 -1) downto 0) := "010";
constant CASE_MULHU : unsigned ((3 -1) downto 0) := "011";
constant CASE_DIV : unsigned ((3 -1) downto 0) := "100";
constant CASE_DIVU : unsigned ((3 -1) downto 0) := "101";
constant CASE_REMS : unsigned ((3 -1) downto 0) := "110";
constant CASE_REMU : unsigned ((3 -1) downto 0) := "111";
