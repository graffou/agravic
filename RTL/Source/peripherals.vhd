...
entity peripherals is port( clk : IN std_logic; reset_n : IN std_logic; core2mem_i : IN blk2mem_t; gpios_o : OUT unsigned ((32 -1) downto 0) ); end peripherals; architecture rtl of peripherals is component dummy_zkw_pouet is port(clk : in std_logic);end component;
begin
