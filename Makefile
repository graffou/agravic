...
CC_FLAGS = -O2 -g3 -std=gnu++17 -Wfatal-errors
...
regs: genregs.cpp
	$(COMPILER) -g3 -IInclude_libs genregs.cpp -o genregs

# Creates executable 
exe:  $(RTL_CONV) $(CONV) $(SOURCEDIR)main.cpp  
	sed -e 's/:=/=/g' Source/main.cpp | $(COMPILER) $(CC_FLAGS) $(INCLUDES_C) -o dut -g3 -xc++ - 
...
%.vhd	: %.h 
	$(COMPILER) $(CC_FLAGS) $(INCLUDES_VHD) -I$(RINCS) -E -P -w -IInclude_libs -DVHDL $< | sed -e 's/==/=/g' -e 's/!=/~=/g' -e 's/Z@Z/\"/g' | grep -A 100000 -e 'Agravic' > ./RTL/$@
