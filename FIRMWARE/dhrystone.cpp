...
#       define Too_Small_Time (0) //2*HZ)
                /* Measurements should last at least about 2 seconds */
#       define Start_Timer() Begin_Time=(long)time32()
#       define Stop_Timer()  End_Time = (long)time32()
...
/*  if (argc > 2)
  ...
  /* Initializations */
   ...
   Rec_Pointer alloc1[ sizeof (Rec_Type) ];   
   Rec_Pointer alloc2[ sizeof (Rec_Type) ];
  Next_Ptr_Glob = reinterpret_cast<Rec_Pointer>(alloc1);//(Rec_Pointer) malloc (sizeof (Rec_Type));
  Ptr_Glob = reinterpret_cast<Rec_Pointer>(alloc2);//(Rec_Pointer) malloc (sizeof (Rec_Type));
  ...
  fprintf ("Final values of the variables used in the benchmark:\n");
  fprintf ("\n");
  fprintf ("Int_Glob:            %d\n", (int32_t)Int_Glob);
  fprintf ("        should be:   %d\n", (int32_t)5);
  fprintf ("Bool_Glob:           %d\n", (int32_t)Bool_Glob);
  ...
  fprintf ("Ch_2_Glob:           %c\n", (int32_t)Ch_2_Glob);
  fprintf ("        should be:   %c\n", 'B');
  fprintf ("Arr_1_Glob[8]:       %d\n", (int32_t)Arr_1_Glob[8]);
  fprintf ("        should be:   %d\n", (int32_t)7);
  fprintf ("Arr_2_Glob[8][7]:    %d\n", (int32_t)Arr_2_Glob[8][7]);
  fprintf ("        should be:   Number_Of_Runs + 10\n");
  fprintf ("Ptr_Glob->\n");
  fprintf ("  Ptr_Comp:          %d\n", (int32_t)(int) Ptr_Glob->Ptr_Comp);
  fprintf ("        should be:   (implementation-dependent)\n");
  fprintf ("  Discr:             %d\n", (int32_t)(int)Ptr_Glob->Discr);
  fprintf ("        should be:   %d\n", (int32_t)0);
  fprintf ("  Enum_Comp:         %d\n", (int32_t)(int)Ptr_Glob->variant.var_1.Enum_Comp);
  fprintf ("        should be:   %d\n", (int32_t)2);
  fprintf ("  Int_Comp:          %d\n", (int32_t)(int)Ptr_Glob->variant.var_1.Int_Comp);
  fprintf ("        should be:   %d\n", (int32_t)17);
  fprintf ("  Str_Comp:          %s\n", (char*)Ptr_Glob->variant.var_1.Str_Comp);
  fprintf ("        should be:   DHRYSTONE PROGRAM, SOME STRING\n");
  fprintf ("Next_Ptr_Glob->\n");
  fprintf ("  Ptr_Comp:          %d\n", (int32_t)(int) Next_Ptr_Glob->Ptr_Comp);
  fprintf ("        should be:   (implementation-dependent), same as above\n");
  fprintf ("  Discr:             %d\n", (int32_t)(int)Next_Ptr_Glob->Discr);
  fprintf ("        should be:   %d\n", (int32_t)0);
  fprintf ("  Enum_Comp:         %d\n", (int32_t)(int)Next_Ptr_Glob->variant.var_1.Enum_Comp);
  fprintf ("        should be:   %d\n", (int32_t)1);
  fprintf ("  Int_Comp:          %d\n", (int32_t)(int)Next_Ptr_Glob->variant.var_1.Int_Comp);
  fprintf ("        should be:   %d\n", (int32_t)18);
  fprintf ("  Str_Comp:          %s\n",
                                (char*)Next_Ptr_Glob->variant.var_1.Str_Comp);
  fprintf ("        should be:   DHRYSTONE PROGRAM, SOME STRING\n");
  fprintf ("Int_1_Loc:           %d\n", (int32_t)Int_1_Loc);
  fprintf ("        should be:   %d\n", (int32_t)5);
  fprintf ("Int_2_Loc:           %d\n", (int32_t)Int_2_Loc);
  ...
  fprintf ("Int_3_Loc:           %d\n", (int32_t)Int_3_Loc);
  fprintf ("        should be:   %d\n", (int32_t)7);
  fprintf ("Enum_Loc:            %d\n", (int32_t)(int)Enum_Loc);
  fprintf ("        should be:   %d\n", (int32_t)1);
  fprintf ("Str_1_Loc:           %s\n", Str_1_Loc);
  fprintf ("        should be:   DHRYSTONE PROGRAM, 1'ST STRING\n");
  fprintf ("Str_2_Loc:           %s\n", Str_2_Loc);
  fprintf ("        should be:   DHRYSTONE PROGRAM, 2'ND STRING\n");
  fprintf ("\n");
    ...
    //                    / (float) User_Time;
    DMIPS_PER_MHZ = ((float) HZ * (float) Number_Of_Runs)
                        / (float) User_Time / 1757.0 / (float(HZ)/1000000.0);
 //   printf ("Microseconds for one run through Dhrystone: ");
  //  printf ("%f \n", Microseconds);
 /*   printf ("Dhrystones per Second:                      ");
    printf ("%f \n", Dhrystones_Per_Second);*/
    printf ("DMIPS/MHz * 1000: ");
    printf ("%f \n", uint32_t(DMIPS_PER_MHZ*1000)); 
    printf ("\n");
